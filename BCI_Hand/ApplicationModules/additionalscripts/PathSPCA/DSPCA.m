...
numeigs=1;      % # of eigenvalues to take at a time in partial eig decomposition
addeigs=1;      % # of eigenvalues to add at a time when taking more than numeigs
maxit_eigs=500; % maximum # of iterations in partial eig decomposition using MATLAB's eigs
...
check_for_unnec_eigs=10;   % # of iterations between checks for how many eigenvalues being used are necessary for partial eigenvalue decomposition (checked in util.c)
