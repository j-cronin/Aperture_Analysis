...
save figure_subset_selection_opt_1
...
xlabel('log(\sigma)','fontsize',16);
xlabel('Probability of optimality','fontsize',16);
legend('greedy - achieved','greedy - provable', 'lasso - achieved')
hold off
