...
%   samexaxis('abc','xmt','on','ytac','join','yld',1, 'YAxisGap', 0.001)
%
% ---
...
Args=struct('YAxisLocation','left','XAxisLocation','bottom','Box','on','XLim',...
    [],'XTick',[],'XTickLabel',[],'XMinorTick',[],'YLabelDistance',1.4,'ABC',false,...
    'Join',false,'YTickAntiClash',false, 'YAxisGap', 0.000); 
...
if Args.Join
    ...
    for ii=2:length(ax)
        ...
        if Args.YAxisGap
            pos(ii,4) = pos(ii,4)-Args.YAxisGap;
        end
