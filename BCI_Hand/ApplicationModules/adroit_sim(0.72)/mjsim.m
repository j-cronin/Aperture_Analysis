...
controls = [framerate_panel slowdown_panel]';
...
% tooltips
tips	= struct(...
			'algorithm',	sprintf('0: PYRAMID\n1: CONE\n2: USER\n'),...
			'integrator',	sprintf('0: EXPLICIT\n1: MIDPOINT\n2: IMPLICIT\n3: RK4\n4: INTERLEAVE'),...
			'atype',		sprintf('0: FULL\n1: EXACT_DIAG\n2: FAST_DIAG\n'),...
...
ignore = {'disableflags','eqsoft','fastdiag','remotecontact','fwdinv'};  
