...
%
function filteredSignals = ecogFilter(signals, lnReject, lnFreqs, hp, hpFreq, lp, lpFreq, fSamp, filterOrder)
...
function rSignals = subFilter(b, a, signals)
