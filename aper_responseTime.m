function [ responseTime_open, responseTime_closed, responseTime_in  ] = aper_responseTime(locs_movement, stimChanges, stimPeaks, Fs, targetStimAmp, closedStimAmp, correctOnly)
